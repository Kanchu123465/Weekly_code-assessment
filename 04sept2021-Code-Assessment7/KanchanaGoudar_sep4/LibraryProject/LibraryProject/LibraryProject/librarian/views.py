...
def searchapi(request):
    try:
        ...
        return render(request,"search.html",{"data":lib_s.data},{"data":user_serialiser.data})
...
def update_searchapi(request):
    try:
        ...
        getpat=Librarian.objects.filter(Lcode=getlcode)
        lib_s=LibrarianSerialize(getpat,many=True)
        return render(request,"update.html",{"data":lib_s.data},{"data":user_serialiser.data})
...
def update_data_read(request):
    ...
    mydata={"Lcode":getlcode,"Name":getname,"Address":getadress,"Mobile":getphone,"Pincode":getpincode,"Email":getemail,"Username":getUsername,"Password":getPassword}
...
def login_check(request):
    try:
        ...
        user_serialiser = LibrarianSerialize(getUsers, many=True)
